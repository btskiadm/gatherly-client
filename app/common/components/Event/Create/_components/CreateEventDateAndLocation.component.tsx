...
import { ZodFlattenIssue, createEventDateAndLocationSchema, flattenIssues } from "@/app/common/utils/zod";
...
export const CreateEventDateAndLocation = forwardRef<CreateEventDateAndLocationRef, Props>(
  ({ date: _date = "", from: _from = "", to: _to = "" }, ref) => {
          ...
          <Grid2 size={{ xs: 12, sm: 5 }}>
            <FormControl error={!!dateError} fullWidth>
              ...
              <TruncatedFormHelperText>
                {!dateError ? <>Data rozpoczęcia</> : dateError.message}
              </TruncatedFormHelperText>
            </FormControl>
          </Grid2>
