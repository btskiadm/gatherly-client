...
export const SignIn = ({ loading, onSubmit }: Props) => {
  // State management
  const [formData, setFormData] = useState<LoginData>({ provider: "credentials", username: "", password: "" });
    ...
    >
      ...
      <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
        ...
        <Typography sx={{ textAlign: "center" }}>
          ...
          <Link href="/auth/sign-up" variant="body2" sx={{ alignSelf: "center" }}>
            Sign up
          </Link>
        </Typography>
      </Box>
