...
import { CloudUploadOutlined, CropRotateOutlined, ImageSearchOutlined } from "@mui/icons-material";
...
function ColorlibStepIcon(props: StepIconProps) {
  ...
  const icons: { [index: string]: React.ReactElement<any> } = {
    1: <ImageSearchOutlined />,
    2: <CropRotateOutlined />,
    3: <CloudUploadOutlined />,
  };
...
const steps = ["Choose", "Crop", "Upload"];

export const UploadStep = ({ step, errorStep }: { step: number; errorStep?: number }) => {
  return (
