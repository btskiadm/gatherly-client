      ...
      DBGroups.push({
        ...
        events: Array(groupEventsCount)
          ...
          .map((_, eventIdx) => {
            ...
            eventCreatedAt.setDate(eventCreatedAt.getDate() + eventIdx * 8);
            ...
            return {
              ...
              date: {
                id: `${gId}_evente_${eventIdx}_date`,
        ...
        comments: Array(groupIdx * 2)
          .fill("")
          .map((_, commentIdx) => {
            const createdAt = new Date(groupCratedAt);
            createdAt.setHours(createdAt.getHours() + commentIdx * Math.PI);

            return {
              id: `${gId}_comment_${commentIdx}`,
